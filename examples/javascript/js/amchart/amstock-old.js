AmCharts.AmStockChart = AmCharts.Class({
    ...
    write: function(a) {
        ...
        this.amExport && AmCharts.AmExport && (this.AmExport = AmCharts.extend(this.amExport, new AmCharts.AmExport(this),
            !0));
        ...
        this.chartScrollbarSettings =
            AmCharts.processObject(this.chartScrollbarSettings, AmCharts.ChartScrollbarSettings, b);
        ...
        this.periodSelector &&
            (this.periodSelector = AmCharts.processObject(this.periodSelector, AmCharts.PeriodSelector, b));
        a.innerHTML = "";
        this.div = a;
        this.measure();
        this.createLayout();
    ...
    updateEvents: function(a) {
        AmCharts.ifArray(a.stockEvents) && AmCharts.parseEvents(a, this.panels,
    ...
    getFirstDate: function(a) {
        ...
        a = a instanceof Date ? new Date(a.getFullYear(), a.getMonth(), a.getDate(),
            a.getHours(), a.getMinutes(), a.getSeconds(), a.getMilliseconds()) : b ? AmCharts.stringToDate(a, b) : new Date(a);
    ...
    updateData: function() {
        ...
        if (a) {
            ...
            if (AmCharts.ifArray(c)) {
                ...
                this.lastDate =
                    this.getLastDate(c[c.length - 1][d]);
            ...
            this.glueToTheEnd && this.startDate && this.endDate && this.lastDate && (AmCharts.getPeriodDuration(b.minPeriod), this.startDate = new Date(this.startDate.getTime() + (this.lastDate.getTime() -
                this.endDate.getTime())), this.endDate = this.lastDate, this.updateScrollbar = !0);
    ...
    createLayout: function() {
        ...
        if ("right" == b || "right" == c) b = document.createElement("div"), b.style.cssFloat = "right", b.style.styleFloat = "right", b.style.width = "0px", d.appendChild(b), this.rightContainer =
            b;
    ...
    measurePanels: function() {
        ...
        for (e = 0; e < a.length; e++) k = a[e], k.percentHeight = k.percentHeight / d * 100, k.panelBox && (k.panelBox.style.height = Math.round(k.percentHeight * this.panelsHeight /
            100) + "px")
    },
    addStockPanel: function(a, b) {
        ...
        if (d = a.stockLegend) d.container =
            void 0, d.title = a.title, d.marginLeft = c.marginLeft, d.marginRight = c.marginRight, d.verticalGap = 3, d.position = "top", AmCharts.copyProperties(this.legendSettings, d), a.addLegend(d, d.divId);
        a.zoomOutText = "";
        a.removeChartCursor();
        this.addCursor(a)
    },
    ...
    zoomChart: function(a, b) {
        ...
        if (e && k) {
            ...
            d.extendToFullPeriod && (g.getTime() - e.getTime() < .1 * y && (g = AmCharts.resetDateToMin(a,
                l.period, l.count, w)), k.getTime() - b.getTime() < .1 * y && (b = AmCharts.resetDateToMin(k, l.period, l.count, w), b = AmCharts.changeDate(b, l.period, l.count, !0)));
            ...
            for (e = 0; e < t.length; e++) {
                ...
                if (f != h) {
                    ...
                    if (c = k.chartCursor) c.categoryBalloonDateFormat = d.chartCursorSettings.categoryBalloonDateFormat(l.period),
                        k.showCategoryAxis || (c.categoryBalloonEnabled = !1);
        ...
        if (0 < this.dataSets.length) {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                for (f = 0; f < k.length; f++) {
                    ...
                    g && c.addGraph(h);
                    r = !1;
                    "always" == c.recalculateToPercents &&
                        (r = !0);
                    var v = c.stockLegend,
                        w, l, y, z;
                    ...
                    if (h.comparable) {
                        ...
                        0 < x && "whenComparing" == c.recalculateToPercents && (h.valueAxis.recalculateToPercents = !0);
                        v && h.valueAxis && !0 === h.valueAxis.recalculateToPercents &&
                            (r = !0);
                        var B;
                        for (B = 0; B < x; B++) {
                            var A = e[B],
                            ...
                            if (g) {
                                ...
                                if (g = h.compareGraphNegativeFillColors) q.negativeFillColors =
                                    g;
                                ...
                                if (g = h.compareGraphBulletBorderColor) q.bulletBorderColor =
                                    g;
                    ...
                    v && (r && w ? (h.legendValueText = w, h.legendPeriodValueText =
                        y) : (l && (h.legendValueText = l), h.legendPeriodValueText = z))
                }
            }
        }
    },
    ...
    handleCursorChange: function(a) {
        ...
        for (k = 0; k < e.length; k++) {
            var f = e[k];
            f != b && c && (f.isZooming(d), f.previousMousePosition =
                NaN, f.forceShow = !0, f.initialMouse = b.initialMouse, f.selectionPosX = b.selectionPosX, f.setPosition(c, !1, a))
        }
    },
...
AmCharts.StockPanel = AmCharts.Class({
    ...
    removeStockGraph: function(a) {
        var b = this.stockGraphs,
            c;
        for (c =
            b.length - 1; 0 <= c; c--) b[c] == a && b.splice(c, 1)
    },
    ...
    handleEraserClick: function() {
        ...
        if (this.eraseAll) {
            ...
            this.validateNow()
        } else(this.erasingEnabled =
            b = !this.erasingEnabled) ? (a && a.show(), this.setTrendColorHover(this.trendLineColorHover), this.setMouseCursor("auto")) : (a && a.hide(), this.setTrendColorHover())
    },
    ...
    handleDraw: function(a) {
        ...
        a = a.finalY;
        var f =
            new AmCharts.TrendLine(this.theme);
